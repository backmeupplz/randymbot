...
const localizations: { [index: string]: { [index: string]: string } } = {
  private_help_start: {
    ...
    tr:
������ 'Merhaba! Ben Randy Marsh. Bir sohbet veya kanalda rastgele bir �ekilis katilimcisini ("Katil" d�gmesine basan) se�ebilirim. Kaynak kodum [here] (https://github.com/backmeupplz/randymbot). Ayrica / dilini ve / �ekilis basina kazananlarin sayisini da degistirebilirsiniz (varsayilan 1).\N\n1. Beni bir kanala veya gruba ekle, /randy komutunu g�nder ve �ekilis baslasin!\N2. �ekilisi bitirmek i�in �ekilis iletime herhangi bir mesajla yanit verin ve katilimcilardan rastgele bir kazanan se�ilecektir.\N\n T�rk�e: @HolyTotem Baska sorularin mi var? Destek kanalimiza gelin — @borodutch\\_support 🦄',
  },
  public_help_start: {
    ru:
